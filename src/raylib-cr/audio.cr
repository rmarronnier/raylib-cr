...
lib RAudio
  ...
  fun wave_valid? = IsWaveValid(wave : Wave) : Bool
  ...
  fun sound_valid? = IsSoundValid(sound : Sound) : Bool
  ...
  fun music_valid? = IsMusicValid(music : Music) : Bool
  ...
  fun audio_stream_valid? = IsAudioStreamValid(stream : AudioStream) : Bool
